...
def get_sections(data: Dict[str, str]) -> List[str]:
    sections_check = set()
    sections = []
    for p in data:
        docs = p["documents"]
...
def parse_pubmed_data(data, section_list: List[str] = None) -> Dict[str, Any]:
...
def parse_pubmed_json(json_string: str, section_list=None) -> Dict[str, Any]:
